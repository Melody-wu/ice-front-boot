...
function start(program) {
  ...
  const getIceConfig = require('../config/getIceConfig');
  //fs.readFileSync(path.join(__dirname, './a.txt'));  ==  fs.readFileSync(require.resolve('./a.txt'));
  // require.resolve 该方法会将相对路径拼接生成一个绝对路径 ,还会在拼接好路径之后检查该路径是否存在
  ...
  const port = getIceConfig(program).port;
  console.log(port);
  return
